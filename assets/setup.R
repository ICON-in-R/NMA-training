...
course_site=function(url="../../index.html",title="Back to STAT0019 website",fill="#bcc0c4") {
...
bmhe=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Bayesian Methods in Health Economics</i>',txt_chapter,
...
bugs_book=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>The BUGS Book</i>',txt_chapter,
...
daniels=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Missing data in longitudinal studies</i>',txt_chapter,
...
esdm=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Evidence Synthesis for Decision Making in Healthcare</i>',txt_chapter,
...
gelman_hill=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Data Analysis Using Regression and Multilevel/Hierarchical Models</i>',txt_chapter,
...
kruschke=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Doing Bayesian Data Analysis</i>',txt_chapter,
...
bacthc=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Bayesian approaches to clinical trials and health care evaluation</i>',txt_chapter,
...
briggs=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Decision Modelling for Health Economic Evaluation</i>',txt_chapter,
...
nma_r=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Doing Meta-Analysis in R</i>',txt_chapter,
...
bcea_book=function(chapter=NULL) {
  ...
  paste0(icons::fontawesome("book"),' <i>Bayesian Cost-Effectiveness Analysis with the R package BCEA</i>',txt_chapter,
...
ref_lecture=function(lecture,name=NULL) {
  ...
  paste0('<a href="../',syllabus %>% filter(title_code==lecture) %>% pull(path),url,'">Lecture ',syllabus %>% filter(title_code==lecture) %>% pull(number),'</a>')
}

previous_slide=function(lecture) {
  paste0(icons::fontawesome("arrow-circle-left"),' <a href="../',syllabus %>% filter(title_code==lecture) %>% pull(path),'/index.html" style="color:#C5283D!important; font-family: Ubuntu;">Previous lecture</a>')
}
...
#custom=icons::icon_set("../img/academicons")
